...
const youtubeTools = [
  ...
  { href: "/thumbnail-generator", title: "Thumbnail Generator", description: "Generate multiple eye-catching thumbnail images from a single prompt.", icon: ImageIcon, imageUrl: "https://placehold.co/500x300.png", dataAiHint: "cyberpunk artwork" },
...
const utilityTools = [
  ...
  { href: "/feature-to-video", title: "Feature to Video", description: "Generate a script, storyboard, and voiceover from a feature description.", icon: Video, imageUrl: "https://placehold.co/500x300.png", dataAiHint: "abstract video editing" },
];
